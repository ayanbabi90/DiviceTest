...
public class RunningAppActivity extends AppCompatActivity {
    ...
    private ShowAppAdapter showAppAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EasyBatteryMod easyBatteryMod = new EasyBatteryMod(RunningAppActivity.this);
        ...
        */
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog dialog = new Dialog(RunningAppActivity.this);
                ...
                ActivityManager actvityManager = (ActivityManager) RunningAppActivity.this.getSystemService(ACTIVITY_SERVICE);
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(RunningAppActivity.this));
    ...
    public class allAppRunningAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... parms) {
            ...
            ActivityManager am = (ActivityManager) RunningAppActivity.this.getSystemService(ACTIVITY_SERVICE);
            PackageManager pm = RunningAppActivity.this.getPackageManager();
            ...
            ActivityManager activityManager = (ActivityManager)RunningAppActivity.this.getSystemService(Context.ACTIVITY_SERVICE);
            ...
            showAppAdapter = new ShowAppAdapter(appList, appListIcons, pids);
        ...
        protected void onPostExecute(Void result) {
            recyclerView = findViewById(R.id.showAppRecylerID);
            recyclerView.setLayoutManager(new LinearLayoutManager(RunningAppActivity.this));
            recyclerView.setAdapter(showAppAdapter);
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(RunningAppActivity.this, "Searching", "App Loading");
            super.onPreExecute();
        }
